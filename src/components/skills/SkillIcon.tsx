...
const SkillIcon = ({ src, name,className }: Props) => {
  return (
    <div className={cn(`relative grid text-2xl rounded-full shadow-md bg-bg-secondary dark:shadow-xl h-14 w-14 sm:h-16 sm:w-16 place-items-center group`,className)}>
